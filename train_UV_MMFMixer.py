...
from dataloader_UV import Mydataset
import argparse

from models.model_fuse import MMFMixer, ImgNet, SVNet, MMFMixer_UV
import torchvision.models as models

# Experiments on S2UV dataset: refer to https://www.scidb.cn/en/detail?dataSetId=14e27d8c51ec40079b84591e9bb24df6
...
def main(args):
    ...
    # train_txt='data\\test_1_10.txt'
    # val_txt='data\\val_1_10.txt'
    # test_txt='data\\train_8_10.txt'
    ...
    train_dataset=Mydataset(X=r'.\\data\\train_X.npy', y=r'.\\data\\train_Y.npy', transform=test_transform)
    val_dataset=Mydataset(X=r'.\\data\\val_X.npy', y=r'.\\data\\val_Y.npy', transform=test_transform)
    test_dataset=Mydataset(X=r'.\\data\\test_X.npy', y=r'.\\data\\test_Y.npy', transform=test_transform)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % 1 == 0:
            ...
            classes = ('UV', 'Others')  # {'住宅区': 0, '公共服务区域': 1, '商业区': 2, '工业区': 3}
        ...
        if acc_2 > best_acc_2:
            ...
            torch.save(model2, os.path.join(args.model_path, 'MMF-UV-3.pth'))
            best_acc_2 = acc_2
            best_epoch = epoch
        # if acc_3 > best_acc_3:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_path", default='./model-UV', type=str)
